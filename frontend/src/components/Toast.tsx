      ...
      <AnimatePresence>
        {toasts.map((toast) => (
          <motion.div
            ...
            role="status"
            aria-live="polite"
            className="pointer-events-auto relative flex w-full items-center justify-between gap-3 overflow-hidden rounded-md border border-line bg-sunken px-4 py-3 shadow-overlay"
          >
