  ...
  return createPortal(
    ...
    >
      ...
      <div className="absolute top-4 right-4 z-30 flex items-center gap-2">
        <div className="flex items-center gap-1 rounded-full border border-white/10 bg-white/[0.06] backdrop-blur-xl px-2 py-1.5">
              ...
              {onAddTag && (
                <div className="relative">
                  ...
                  {tagSuggestions.length > 0 && (
                    <div className="absolute left-0 top-full mt-1 z-50 w-44 rounded-xl border border-white/10 bg-[#0d1526]/95 backdrop-blur-xl shadow-xl overflow-hidden">
      ...
      {/* Share toast */}
      {shareToast && (
        <div className="absolute top-16 left-1/2 -translate-x-1/2 z-50 rounded-full bg-white/10 backdrop-blur-xl border border-white/10 px-4 py-1.5 text-xs text-white/80 animate-in fade-in duration-200">
          {shareToast}
        </div>
      )}
      ...
      {/* Rating toast */}
      {ratingToast !== null && (
        <div className="absolute top-16 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 rounded-full bg-black/70 backdrop-blur-xl border border-yellow-400/30 px-4 py-2 animate-in fade-in duration-150">
