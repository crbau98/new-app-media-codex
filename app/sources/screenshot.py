...
CREATOR_QUERIES: dict[str, str] = {
    ...
    # Additional well-known gay creators
    "troye dean":          '"troye dean" gay nude onlyfans',
    "johnny rapid":        '"johnny rapid" gay nude',
    "str8crushfeet":       '"str8crushfeet" gay onlyfans',
...
TERM_TO_THEME: dict[str, str] = {
    ...
    "big cock gay":        "erections",
    "uncut cock":          "penile_anatomy",
    "foreskin":            "penile_anatomy",
    "balls":               "penile_anatomy",
    "perineum":            "penile_anatomy",
    "gay ass":             "penile_anatomy",
    "gay nipples":         "penile_anatomy",
    # Ejaculation
    ...
    "gay creampie":        "ejaculation_latency",
    "cum eating gay":      "ejaculation_latency",
    "gay facial":          "ejaculation_latency",
    # Orgasm
    "gay orgasm":          "orgasm",
    "prostate orgasm":     "orgasm",
    "ruined orgasm":       "orgasm",
    "gay multiple orgasm": "orgasm",
    # Sex acts
    "blowjob":             "sexual_acts_physiology",
    "gay deepthroat":      "sexual_acts_physiology",
    ...
    "gay threesome":       "sexual_acts_physiology",
    "glory hole":          "sexual_acts_physiology",
    "gay breeding":        "sexual_acts_physiology",
    # Solo / intimate
    "gay solo":            "libido",
    "gay shower":          "libido",
    "gay sauna":           "libido",
    ...
    # Fashion / gear / kink
    "jockstrap":           "libido",
    "gay underwear":       "libido",
    "gay speedo":          "libido",
    "gay leather":         "libido",
    "cock ring":           "erections",
    "chastity gay":        "erections",
    "gay bondage":         "libido",
}
